...
<script>
    ...
    if(isset($_POST["signup"])){
      ...
      $query="insert into tbl_user (name,email,phone,dob,username,password,photo,identity,status) values('$name','$email','$phone','$dob','$username','$password','$photo','$identity','0')";
      ...
      $otp = rand(100000,999999);
                    ...
                    $mail->setFrom('your_mail', 'SAHAYATHRI OTP Verification');
                    ...
                    <b>SAHAYATHRI</b>";
                            ...
                            if(!$mail->send()){
                                ...
                                <script>
                                    ...
                                    window.location.replace('regverification.php');
                                </script>
                                <?php
                            }
    }
