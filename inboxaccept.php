...
$query="select * from tbl_request where sender_id='$checkid' or receiver_id='$checkid'";
...
<section id="received" style="height:fit-content;">
    <div class="container" style="margin-top: 61px;">
      <header>
        <div class="notif_box">
          <h2 class="title">Accepted Request</h2>
        </div>
      </header>
      <main style="align-items: center;">
        ...
        <div><table><tr style="height: 78px;">
          ...
          <td style="width: 81px;"><img src="upload/<?php echo $photo2?>" style="height:50px; width:50px; border-radius:50%" alt="avatar" /></td>
         <td style="width: 483px;"> <label style="padding-left: 18px;"><?php echo $name;?> and <?php echo $name2;?> you both accepted on a trip to <?php echo $dest;?>.If needed book hotels!!</label></td>
        <td style="width: 100px;"><a href="hotelbooking.php"><button type="button" class="btn btn-dark" style="width: 106px;">Book Now</button></a></td>
        </tr></div>
           <?php }
           else{
            ?>
            <label style="margin-top: 104px;font-size: 15px;font-weight: 800;">You Havn't Made any trip!!</label>
            <?php
           }
           }}
           else{
