							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="smooth-menu"><a href=".tab-content">Companion</a></li>
										<li><a href="inbox.php">Inbox</a></li>
										<li class="smooth-menu"><a href=".testemonial">Review</a></li>
										<li>
										<div class="dropdown">
  										<a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										  <img src="upload/<?php echo $photo?>" style="border-radius:50%;width: 60px;height:60px;">
											</a>						
											<ul class="dropdown-menu" style="background-color:black";>
											<li><a class="dropdown-item" href="usertest.php">Profile</a></li>
						...
						<div class="col-sm-12">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>  
										Find Your Travel Companion Here!!
									</h2>
									<div class="about-btn">
										<a href="maketrip.php"><button  class="about-view">
											Make Trip
										</button></a>
									</div><!--/.about-btn-->
								</div><!--/.about-us-txt-->
...
<div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane active fade in" id="tours">
		<div class="tab-para" style="width: 1080px;">
			...
			<div class="row">
				...
				<div class="clo-sm-7">
													<div class="about-btn travel-mrt-0 pull-right">
														<a href="availabletrip.php"><button  class="about-view travel-btn" style="margin-right: 274px;width: 431px;">
															Available Trips	
														</button></a><!--/.travel-btn-->
													</div><!--/.about-btn-->
												</div><!--/.col-->
						  		...
						  		<div class="row">
						  			...
						  			<div class="col-md-4">
						  				<div class="filtr-item">
											...
											<div class="item-title">
												<a href="availabletripswitzerland.php">
													Switzerland
												</a>
						  			...
						  			<div class="col-md-8">
						  				<div class="filtr-item">
											...
											<div class="item-title">
												<a href="availabletripbrazil.php">
													Brazil
												</a>
